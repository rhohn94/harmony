...
| `docs/grimoire/version-design.md` | operator-facing | stay at `docs/` |
...
| `docs/grimoire/integration-workflow.md` | agent-only (paradigm-managed) | **move → `docs/grimoire/`** |
...
```
git mv docs/grimoire/integration-workflow.md        docs/grimoire/integration-workflow.md
...
copy at `docs/grimoire/integration-workflow.md` is *written by the
...
1. **Update the `grm-work-paradigm-switch` install-map target.** In
   ...
   `docs/grimoire/integration-workflow.md` must become
...
2. **Update every paradigm source's internal `docs/grimoire/integration-workflow.md`
   ...
   `docs/grimoire/integration-workflow.md` §sections and must be repointed to
...
> to the **active doc path** `docs/grimoire/integration-workflow.md` → these repoint to
