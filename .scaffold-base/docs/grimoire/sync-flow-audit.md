...
| `docs/*.md` (structural) | YES | `docs/grimoire/integration-workflow.md`, `docs/grimoire/version-design.md` etc. all synced. `docs/roadmap.md` and `docs/design/README.md` are excluded. |
